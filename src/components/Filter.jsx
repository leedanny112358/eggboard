      ...
      <div id="filters">
        ...
        <div className="filter-grid-container">
          <button
            ...
            onClick={(e) => this.handleClickLang("Java", e)}
          >
            Java
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("Python", e)}
          >
            Python
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("C/C++", e)}
          >
            C/C++
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("HTML/CSS/JavaScript", e)}
          >
            HTML/CSS/JavaScript
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("SQL", e)}
          >
            SQL
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("Swift", e)}
          >
            Swift
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("Objective C", e)}
          >
            Objective C
          </button>
          <button
            className="filter-grid-item-lang"
            onClick={(e) => this.handleClickLang("C#", e)}
          >
            C#
          </button>
        </div>
        ...
        <div className="filter-grid-container">
          <button
            ...
            onClick={(e) => this.handleClickSpec("Backend", e)}
          >
            Backend
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Frontend", e)}
          >
            Frontend
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Web Dev", e)}
          >
            Web Dev
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Mobile/iOS", e)}
          >
            Mobile/iOS
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Low-Level", e)}
          >
            Low-Level
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Software Tools", e)}
          >
            Software Tools
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Security", e)}
          >
            Security
          </button>
          <button
            className="filter-grid-item-spec"
            onClick={(e) => this.handleClickSpec("Cloud Computing", e)}
          >
            Cloud Computing
          </button>
        </div>
        ...
        <div className="filter-grid-container">
          <button
            ...
            onClick={(e) => this.handleClickCat("Just for fun", e)}
          >
            Just for fun
          </button>
          <button
            className="filter-grid-item-cat"
            onClick={(e) => this.handleClickCat("For class", e)}
          >
            For class
          </button>
          <button
            className="filter-grid-item-cat"
            onClick={(e) => this.handleClickCat("Start-up", e)}
          >
            Start-up
          </button>
          <button
            className="filter-grid-item-cat"
            onClick={(e) => this.handleClickCat("Open source", e)}
          >
            Open source
          </button>
        </div>
        ...
        <div className="filter-grid-container-2">
          <button className="filter-go" onClick={() => this.handleClickGo()}>
            Go
          </button>
        </div>
      </div>
